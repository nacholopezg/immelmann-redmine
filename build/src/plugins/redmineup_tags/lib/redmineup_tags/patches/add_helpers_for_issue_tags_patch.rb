...
[IssuesController, CalendarsController, GanttsController, SettingsController, ActivitiesController, PivottablesController, IssuesTreesController].each do |controller|
